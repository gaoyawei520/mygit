...
//    public AndroidElement handOversButton(){ return handOversButton; }
    ...
    public void login() throws InterruptedException {
        Thread.sleep(3000);
        driver.findElementById(Environment.PackageName +":id/userNameET").clear();
        driver.findElementById(Environment.PackageName +":id/userNameET").sendKeys("18888886667");
        driver.findElementById(Environment.PackageName +":id/userPwdET").clear();
